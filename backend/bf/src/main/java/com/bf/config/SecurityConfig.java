...
import com.bf.common.auth.JwtAuthenticationFilter;
import com.bf.common.auth.SsafyUserDetailService;
...
//    @Autowired
//    public SecurityConfig(UserService userService, SsafyUserDetailService ssafyUserDetailService){
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/api/auth/login").authenticated()//                .antMatchers("/")
